# Generated by Powerlevel10k configuration wizard on 2019-12-08 at 02:10 CET.
# Based on romkatv/powerlevel10k/config/p10k-pure.zsh, checksum 53025.
# Wizard options: compatible, pure, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_OUTGOING_CHANGESFORMAT_FOREGROUND=2
  typeset -g POWERLEVEL9K_VCS_INCOMING_CHANGESFORMAT_FOREGROUND=3
